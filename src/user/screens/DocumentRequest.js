...
const DocumentRequest = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            <Header userName={userName} userRole={userRole} handleLogout={handleLogout} getCurrentDate={getCurrentDate} />
            <div className="flex flex-1">
                <Navigation adminData={adminData} getCurrentDate={getCurrentDate} />
                <main className="flex-1 p-8 bg-gray-100">
                    <h1 className="text-4xl font-bold mb-10 text-gray-700">Document Request</h1>
                    <div className="flex justify-around mb-1">
                        <div className="bg-white p-6 rounded-lg shadow w-full">
                            <h2 className="text-2xl font-semibold mb-6">List of Document Request</h2>
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <div className="w-48">
                                  <label htmlFor="date" className="block text-sm font-medium text-gray-700">Date</label>
                                    ...
                                    <button className="mt-7 text-blue-500 hover:text-[#1A50BE] cursor-pointer font-semibold" onClick={resetFilters}>
                                        Reset Filters
                                    </button>
                                </div>
                                ...
                                <div className="flex items-center space-x-1">
                                  ...
                                  <div className="relative inline-flex items-center">
                                    <select
                                      id="sortBy"
                                      name="sortBy"
                                      className="block appearance-none py-1 text-base text-[#1346AC] font-semibold hover:text-blue-500 focus:outline-none focus:ring-0 pl-2 pr-6" // Adjusted pr to 6 for spacing
                                      value={sortBy}
                                    ...
                                    <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-1 ml-1"> 
                                      <svg
