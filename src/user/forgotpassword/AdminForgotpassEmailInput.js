...
const AdminForgotpassEmailInput = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${process.env.REACT_APP_BACKEND_API_KEY}/api/admin/forgot-password`, { email });
            Swal.fire({
                title: 'Success!',
            ...
            navigate('/Admin/enter-security-code', { state: { email } });
        } catch (error) {
...
export default AdminForgotpassEmailInput;
